...
describe("Insert() test", () => {
  test("create test", async () => {
    ...
    const results = await mysqlCon.query(`SELECT * FROM albums WHERE id = 21`);
  ...
  test("bulkCreate test", async () => {
    ...
    const results = await mysqlCon.query(`SELECT * FROM albums WHERE id = 22`);
    const results2 = await mysqlCon.query(`SELECT * FROM albums WHERE id = 23`);
